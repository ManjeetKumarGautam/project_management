...
import DeleteTaskDialog from "@/components/task/confirm-delete-task";
import DeleteWorkspaceDialog from "@/components/task/confirm-delete-task";
  ...
  return (
    <div className="container mx-auto p-0 py-4 md:px-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-2/3 w-full col-span-3">
          <div className="bg-card rounded-lg p-6 shadow-sm mb-6">
            ...
            <div className="flex items-center space-x-1">
              <Paperclip className="w-4 h-4 text-muted-foreground -rotate-45" />
              <h3 className="text-sm font-medium text-muted-foreground">
                Attachement
              </h3>

            </div>
            <p className="text-muted-foreground text-sm mt-2">No attachement yet</p>
