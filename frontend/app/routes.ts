...
export default [
  ...
  layout("routes/dashboard/dashboard-layout.tsx", [
    ...
    route("setting", "routes/dashboard/setting.tsx"),
    route("workspaces/:workspaceId/projects/:projectId/settings", "routes/dashboard/project/project-settings.tsx")
  ]),
  ...
  layout("routes/user/user-layout.tsx", [
    ...
    route("user/notifications", "routes/user/notification.tsx"),
  ]),
