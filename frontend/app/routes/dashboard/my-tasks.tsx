  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start md:items-center justify-between">
        ...
        <div
          className="flex flex-col items-start md:flex-row md itemScope
          gap-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  gap-4">
            <Card className="bg-blue-50">
              <CardHeader className=" ">
                <CardTitle className="flex items-center justify-between bg-blue-200 py-2 px-4 rounded-full">
                  To Do
            ...
            <Card className="bg-orange-50">
              <CardHeader>
                <CardTitle className="flex items-center justify-between bg-orange-200 py-2 px-4 rounded-full">
                  In Progress
            ...
            <Card className="bg-green-50">
              <CardHeader>
                <CardTitle className="flex items-center justify-between bg-green-200 py-2 px-4 rounded-full">
                  Done
